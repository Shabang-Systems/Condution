            ...
            Storage.get({key: 'condution_stotype'}).then((async function(dbType) {
                switch (dbType.value) {
                    ...
                    case "json":
                        ...
                        this.props.cm.useProvider("json");
                    ...
                    case "workspace":
                        if (uri[1] !== "workspaces") {
                            this.props.cm.useProvider("firebase");
    ...
    authDispatch(mode) {
        ...
        switch (mode.operation) {
            ...
            case "create":
                ...
                //Engine.use(mode.service, this.gruntman.requestRefresh);
                this.props.cm.useProvider(mode.service);
                Storage.set({key: 'condution_stotype', value: mode.service});
//                switch (mode.service) {
                    //// if its firebase
                    //case "firebase":
            ...
            case "logout":
                ...
                if (this.props.cm.auth)
                    this.props.cm.auth.deauthenticate();
                // Load the auth view
